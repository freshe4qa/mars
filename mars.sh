...
curl -s https://raw.githubusercontent.com/mars-protocol/networks/main/ares-1/genesis.json > $HOME/.marsd/config/genesis.json
...
# set peers and seeds
SEEDS=""
PEERS="6c855909a8bf1c12ef34baca059f5c0cdf82bc36@65.108.255.124:36656"
